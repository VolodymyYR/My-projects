(() => {
    ...
    function clickDocument(e) {
        const targetElement = e.target;
        if (targetElement.closest(".header-actions__search-button")) {
            const header = document.querySelector(".header");
            header.classList.toggle("search-open");
        }
        if (document.querySelector(".search-open")) if (!targetElement.closest(".header-actions__search-body")) {
        ...
        if (targetElement.closest(".menu__button")) {
            const subMenu = document.querySelector(".item--parent");
            subMenu.classList.toggle("sub-menu-open");
        }
        if (document.querySelector(".sub-menu-open")) if (!targetElement.closest(".item--parent")) {
            const openMenu = document.querySelector(".sub-menu-open");
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) {
            const swiperCardPhoto = new swiper_core_Swiper(".main-card-intro__slider", {
                ...
                loop: true,
                scrollbar: {
                    el: ".main-card-intro__placeholder",
                    draggable: true
                },
                navigation: {
                    nextEl: ".main-card-intro__arrow"
                },
                on: {}
            });
            const swiperCardBody = new swiper_core_Swiper(".info-card__slider", {
                modules: [ Navigation, Controller ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            new swiper_core_Swiper(".slider-intro-reviews__slider", {
            ...
            swiperCardPhoto.controller.control = swiperCardBody;
            swiperCardBody.controller.control = swiperCardPhoto;
            const swiperCardBest = new swiper_core_Swiper(".content-best-photo__slider", {
                ...
                loop: true,
                navigation: {
                    nextEl: ".content-best__arrow--next",
                    prevEl: ".content-best__arrow--prev"
                },
                on: {}
            });
            const swiperCardBestBody = new swiper_core_Swiper(".content-best-body__slider", {
                modules: [ Navigation, Controller, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                loop: true,
                pagination: {
                    el: ".content-best__pagination",
                    type: "fraction"
                },
                on: {}
            });
            swiperCardBest.controller.control = swiperCardBestBody;
            swiperCardBestBody.controller.control = swiperCardBest;
        }
    }
